export const About = () => {
    ...
    return (
        <div className="container mx-auto">
            <h1 className="text-white font-bold text-6xl mb-10">Nice to meet you!<br/>I’m Yaroslav Dudar.</h1>
            <div>
                <ul className="flex flex-col gap-3">
                    {person.map(( {address, phone, email, dateOfBirth, launguages }, index) => {
                        return (
                            <>
                                <li key={index} className="text-xl font-medium flex items-center gap-2 text-slate-300">
